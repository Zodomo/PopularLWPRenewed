    ...
    public final Object a(String str, Object obj) {
        ...
        try {
            if (cursorRawQuery.moveToFirst()) {
                String string = cursorRawQuery.getString(cursorRawQuery.getColumnIndexOrThrow("codeValue"));
                String string2 = cursorRawQuery.getString(cursorRawQuery.getColumnIndexOrThrow("codeDataType"));
                str3 = string;
                str2 = string2;
                z = true;
            } else {
