...
public class HSectorView extends ImageView {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.needsRefresh) {
            Bitmap bitmapA = orientation == 0 ? com.CatShockEntertainment.ColorPicker.c.a(256, 1, a(this.a), orientation) : com.CatShockEntertainment.ColorPicker.c.a(1, 256, a(this.a), orientation);
        ...
        float fA = (this.a[0] - (a(this.a) * 60.0f)) / 60.0f;
        if (orientation == 0) {
