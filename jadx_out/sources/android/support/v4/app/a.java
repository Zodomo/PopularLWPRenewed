        ...
        if (this.k) {
            ...
            for (b bVar = this.b; bVar != null; bVar = bVar.a) {
                if (bVar.d != null) {
                    bVar.d.r += i;
                    if (l.a) {
                        String str2 = "Bump nesting of " + bVar.d + " to " + bVar.d.r;
                    }
                }
                if (bVar.i != null) {
                    for (int size = bVar.i.size() - 1; size >= 0; size--) {
                        ...
                        fragment.r += i;
                        if (l.a) {
                            String str3 = "Bump nesting of " + fragment + " to " + fragment.r;
                        }
                    }
                }
            }
                ...
                case 2:
                    ...
                    if (bVar.i != null) {
                        for (int i = 0; i < bVar.i.size(); i++) {
                            Fragment fragment3 = (Fragment) bVar.i.get(i);
                            fragment3.G = bVar.g;
                ...
                case 2:
                    ...
                    if (this.a.g != null) {
                        ...
                        for (int i = 0; i < this.a.g.size(); i++) {
                            ...
                            if (l.a) {
                                String str2 = "OP_REPLACE: adding=" + fragment + " old=" + fragment4;
                            }
                            if (fragment == null || fragment4.x == fragment.x) {
                                if (fragment4 == fragment) {
                                    ...
                                    if (this.k) {
                                        fragment4.r++;
                                        if (l.a) {
                                            String str3 = "Bump nesting of " + fragment4 + " to " + fragment4.r;
                                        }
                                    }
