...
public final class a {
    ...
    public static void a(Context context) {
        ...
        if (j >= 12 && System.currentTimeMillis() >= lValueOf.longValue() + 259200000) {
            ...
            dialog.setContentView(ac.rate_dlg_layout);
            dialog.setTitle("Rate " + a);
            TextView textView = (TextView) dialog.findViewById(ab.textView);
            textView.setText("If you enjoy using " + a + ", please take a moment to rate it. Thanks for your support!");
            textView.setPadding(10, 10, 10, 10);
            Button button = (Button) dialog.findViewById(ab.button_rate);
            button.setText("Rate " + a);
            button.setOnClickListener(new b(context, editorEdit, dialog));
            Button button2 = (Button) dialog.findViewById(ab.button_remind);
            button2.setText("Remind me later");
            button2.setOnClickListener(new c(dialog));
            Button button3 = (Button) dialog.findViewById(ab.button_nevermind);
