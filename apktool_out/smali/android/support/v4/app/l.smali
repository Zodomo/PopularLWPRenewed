...
.field p:Landroid/support/v4/app/j;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/l;->B:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/AccelerateInterpolator;

    invoke-direct {v0, v3}, Landroid/view/animation/AccelerateInterpolator;-><init>(F)V

    sput-object v0, Landroid/support/v4/app/l;->C:Landroid/view/animation/Interpolator;
...
.method constructor <init>()V
    ...
    iput-object v1, p0, Landroid/support/v4/app/l;->w:Landroid/os/Bundle;

    iput-object v1, p0, Landroid/support/v4/app/l;->x:Landroid/util/SparseArray;

    new-instance v0, Landroid/support/v4/app/m;

    invoke-direct {v0, p0}, Landroid/support/v4/app/m;-><init>(Landroid/support/v4/app/l;)V

    iput-object v0, p0, Landroid/support/v4/app/l;->y:Ljava/lang/Runnable;
...
.method private static a(FF)Landroid/view/animation/Animation;
    ...
    sget-object v1, Landroid/support/v4/app/l;->A:Landroid/view/animation/Interpolator;
...
.method private static a(FFFF)Landroid/view/animation/Animation;
    ...
    sget-object v1, Landroid/support/v4/app/l;->z:Landroid/view/animation/Interpolator;
...
.method private a(Ljava/lang/RuntimeException;)V
    ...
    invoke-virtual {v0, v2, v3, v1, v4}, Landroid/support/v4/app/g;->dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    :try_end_0
...
.method private b(Landroid/support/v4/app/Fragment;)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/l;->x:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Landroid/support/v4/app/l;->x:Landroid/util/SparseArray;

    :goto_1
    iget-object v0, p1, Landroid/support/v4/app/Fragment;->J:Landroid/view/View;

    iget-object v1, p0, Landroid/support/v4/app/l;->x:Landroid/util/SparseArray;
...
.method final a(IIIZ)V
    ...
    iget-object v0, v1, Landroid/support/v4/app/Fragment;->M:Landroid/support/v4/app/v;
    ...
    invoke-direct {p0}, Landroid/support/v4/app/l;->r()V
    ...
    iput-boolean v5, p0, Landroid/support/v4/app/l;->r:Z
...
.method final a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
    ...
    iput-object v6, v0, Landroid/support/v4/app/Fragment;->i:Landroid/support/v4/app/Fragment;
    ...
    iget-object v4, p0, Landroid/support/v4/app/l;->q:Landroid/support/v4/app/Fragment;

    invoke-virtual {v1, v3, v4}, Landroid/support/v4/app/FragmentState;->a(Landroid/support/v4/app/g;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    :cond_11
    iput-object v6, p0, Landroid/support/v4/app/l;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, p0}, Landroid/support/v4/app/BackStackState;->a(Landroid/support/v4/app/l;)Landroid/support/v4/app/a;
    ...
    iget v4, v1, Landroid/support/v4/app/a;->o:I
    ...
    :cond_13
    iget-object v3, p0, Landroid/support/v4/app/l;->i:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3, v1}, Landroid/support/v4/app/l;->a(ILandroid/support/v4/app/a;)V
    ...
    :cond_15
    iput-object v6, p0, Landroid/support/v4/app/l;->i:Ljava/util/ArrayList;
...
.method final a(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v4/app/l;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->t:Landroid/support/v4/app/g;

    iget-object v0, p0, Landroid/support/v4/app/l;->q:Landroid/support/v4/app/Fragment;
    ...
    :goto_2
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->s:Landroid/support/v4/app/l;
    ...
    invoke-static {}, Landroid/support/v4/app/g;->b()V
    ...
    iget-object v0, p0, Landroid/support/v4/app/l;->p:Landroid/support/v4/app/j;

    iget v1, p1, Landroid/support/v4/app/Fragment;->x:I

    invoke-interface {v0, v1}, Landroid/support/v4/app/j;->a(I)Landroid/view/View;
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/app/l;->b(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v4/app/n;-><init>(Landroid/support/v4/app/l;Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/g;->a(Ljava/lang/String;)V
    ...
    :cond_30
    iput-object v7, p1, Landroid/support/v4/app/Fragment;->t:Landroid/support/v4/app/g;

    iput-object v7, p1, Landroid/support/v4/app/Fragment;->s:Landroid/support/v4/app/l;
...
.method public final a(Landroid/support/v4/app/Fragment;Z)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/l;->q:Landroid/support/v4/app/Fragment;
    ...
    iput-boolean v2, p0, Landroid/support/v4/app/l;->r:Z

    :cond_7
    if-eqz p2, :cond_8

    invoke-virtual {p0, p1}, Landroid/support/v4/app/l;->a(Landroid/support/v4/app/Fragment;)V

    :cond_8
    return-void
.end method

.method public final a(Landroid/support/v4/app/g;Landroid/support/v4/app/j;Landroid/support/v4/app/Fragment;)V
    .locals 2
    ...
    iput-object p2, p0, Landroid/support/v4/app/l;->p:Landroid/support/v4/app/j;

    iput-object p3, p0, Landroid/support/v4/app/l;->q:Landroid/support/v4/app/Fragment;
...
.method public final a(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0}, Landroid/support/v4/app/l;->s()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/l;->y:Ljava/lang/Runnable;
...
.method public final b(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-direct {p0, p1, p2, v2, p3}, Landroid/support/v4/app/l;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
...
.method final b(Landroid/support/v4/app/a;)V
    ...
    invoke-direct {p0}, Landroid/support/v4/app/l;->t()V
...
.method public final d()Z
    ...
    iget-object v5, v0, Landroid/support/v4/app/Fragment;->M:Landroid/support/v4/app/v;

    if-eqz v5, :cond_3

    iget-object v0, v0, Landroid/support/v4/app/Fragment;->M:Landroid/support/v4/app/v;
    ...
    iget-object v4, p0, Landroid/support/v4/app/l;->y:Ljava/lang/Runnable;
...
.method final f()Landroid/os/Parcelable;
    ...
    iput-boolean v3, p0, Landroid/support/v4/app/l;->s:Z
    ...
    iget-object v1, p0, Landroid/support/v4/app/l;->w:Landroid/os/Bundle;
    ...
    iput-object v2, p0, Landroid/support/v4/app/l;->w:Landroid/os/Bundle;
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/app/l;->b(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-direct {p0, v11}, Landroid/support/v4/app/l;->a(Ljava/lang/RuntimeException;)V
...
.method public final p()V
    ...
    iput-object v1, p0, Landroid/support/v4/app/l;->o:Landroid/support/v4/app/g;

    iput-object v1, p0, Landroid/support/v4/app/l;->p:Landroid/support/v4/app/j;

    iput-object v1, p0, Landroid/support/v4/app/l;->q:Landroid/support/v4/app/Fragment;
