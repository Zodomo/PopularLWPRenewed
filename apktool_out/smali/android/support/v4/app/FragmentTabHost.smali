...
.field private c:Landroid/support/v4/app/k;
...
.method private a(Ljava/lang/String;Landroid/support/v4/app/s;)Landroid/support/v4/app/s;
    ...
    iget-object v3, v0, Landroid/support/v4/app/r;->a:Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->f:Landroid/support/v4/app/r;

    if-eq v0, v1, :cond_5

    if-nez p2, :cond_2

    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->c:Landroid/support/v4/app/k;
    ...
    iget-object v0, v0, Landroid/support/v4/app/r;->d:Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/s;

    :cond_3
    if-eqz v1, :cond_4

    iget-object v0, v1, Landroid/support/v4/app/r;->d:Landroid/support/v4/app/Fragment;

    if-nez v0, :cond_6

    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->b:Landroid/content/Context;

    iget-object v2, v1, Landroid/support/v4/app/r;->b:Ljava/lang/Class;

    invoke-virtual {v2}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object v2

    iget-object v3, v1, Landroid/support/v4/app/r;->c:Landroid/os/Bundle;
    ...
    iput-object v0, v1, Landroid/support/v4/app/r;->d:Landroid/support/v4/app/Fragment;

    iget v0, p0, Landroid/support/v4/app/FragmentTabHost;->d:I

    iget-object v2, v1, Landroid/support/v4/app/r;->d:Landroid/support/v4/app/Fragment;

    iget-object v3, v1, Landroid/support/v4/app/r;->a:Ljava/lang/String;
    ...
    :cond_4
    :goto_2
    iput-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->f:Landroid/support/v4/app/r;
...
.method protected final onAttachedToWindow()V
    ...
    iget-object v4, p0, Landroid/support/v4/app/FragmentTabHost;->c:Landroid/support/v4/app/k;

    iget-object v5, v0, Landroid/support/v4/app/r;->a:Ljava/lang/String;

    invoke-virtual {v4, v5}, Landroid/support/v4/app/k;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;

    move-result-object v4

    iput-object v4, v0, Landroid/support/v4/app/r;->d:Landroid/support/v4/app/Fragment;

    iget-object v4, v0, Landroid/support/v4/app/r;->d:Landroid/support/v4/app/Fragment;
    ...
    iget-object v4, v0, Landroid/support/v4/app/r;->a:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->f:Landroid/support/v4/app/r;
    ...
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->c:Landroid/support/v4/app/k;

    invoke-virtual {v1}, Landroid/support/v4/app/k;->a()Landroid/support/v4/app/s;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/s;
