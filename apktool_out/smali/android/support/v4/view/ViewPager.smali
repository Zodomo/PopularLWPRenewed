...
.field private static final af:Landroid/support/v4/view/af;
...
.field private R:Landroid/support/v4/d/a;
...
.field private W:Landroid/support/v4/view/ab;

.field private Z:Landroid/support/v4/view/ab;

.field private aa:Landroid/support/v4/view/aa;

.field private ab:Landroid/support/v4/view/ac;
...
.field private final e:Landroid/support/v4/view/y;
...
.field private m:Landroid/support/v4/view/ad;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->af:Landroid/support/v4/view/af;
...
.method private a(I)Landroid/support/v4/view/y;
    .locals 2
    ...
    iput p1, v0, Landroid/support/v4/view/y;->b:I

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
...
.method private a(Landroid/view/View;)Landroid/support/v4/view/y;
    .locals 2
    ...
    :cond_2
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->d()Landroid/support/v4/view/y;
...
.method private a(IF)V
    ...
    iget-boolean v9, v0, Landroid/support/v4/view/z;->a:Z

    if-eqz v9, :cond_a

    iget v0, v0, Landroid/support/v4/view/z;->b:I
    ...
    :cond_5
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/ab;
    ...
    :cond_6
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Z:Landroid/support/v4/view/ab;
    ...
    :cond_7
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/ac;
    ...
    iget-boolean v0, v0, Landroid/support/v4/view/z;->a:Z
...
.method private a(IIII)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/view/ViewPager;->c(I)Landroid/support/v4/view/y;

    move-result-object v3

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->l:Landroid/widget/Scroller;

    iget v3, v3, Landroid/support/v4/view/y;->e:F
    ...
    iget v0, v0, Landroid/support/v4/view/y;->e:F
...
.method private a(IZIZ)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/view/ViewPager;->c(I)Landroid/support/v4/view/y;
    ...
    iget v1, v1, Landroid/support/v4/view/y;->e:F
    ...
    invoke-static {p0}, Landroid/support/v4/view/n;->b(Landroid/view/View;)V
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/ab;
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->Z:Landroid/support/v4/view/ab;
...
.method private a(IZZI)V
    ...
    iput-boolean v3, v0, Landroid/support/v4/view/y;->c:Z
...
.method private a(Z)V
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/y;->c:Z

    if-eqz v5, :cond_2

    iput-boolean v2, v0, Landroid/support/v4/view/y;->c:Z
    ...
    invoke-static {p0, v0}, Landroid/support/v4/view/n;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method private a(F)Z
    ...
    iget v8, v0, Landroid/support/v4/view/y;->b:I
    ...
    :goto_0
    iget v8, v1, Landroid/support/v4/view/y;->b:I

    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;

    invoke-virtual {v9}, Landroid/support/v4/view/i;->a()I
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/d/a;
...
.method private b(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
    ...
    iget v4, v0, Landroid/support/v4/view/y;->b:I
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/view/ViewPager;->a(I)Landroid/support/v4/view/y;
    ...
    iget v10, v6, Landroid/support/v4/view/y;->d:F
    ...
    iget v11, v0, Landroid/support/v4/view/y;->b:I

    if-ne v5, v11, :cond_2

    iget-boolean v11, v0, Landroid/support/v4/view/y;->c:Z
    ...
    iget-object v11, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;

    iget-object v0, v0, Landroid/support/v4/view/y;->a:Ljava/lang/Object;
    ...
    iget v0, v0, Landroid/support/v4/view/y;->d:F
    ...
    :cond_8
    invoke-direct {p0, v5}, Landroid/support/v4/view/ViewPager;->a(I)Landroid/support/v4/view/y;
    ...
    :cond_a
    iget v2, v6, Landroid/support/v4/view/y;->d:F
    ...
    iget v7, v0, Landroid/support/v4/view/y;->b:I

    if-ne v5, v7, :cond_2d

    iget-boolean v7, v0, Landroid/support/v4/view/y;->c:Z
    ...
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
    ...
    iget v2, v1, Landroid/support/v4/view/y;->b:I

    iget v0, v6, Landroid/support/v4/view/y;->b:I

    if-ge v2, v0, :cond_15

    const/4 v0, 0x0

    iget v3, v1, Landroid/support/v4/view/y;->e:F

    iget v1, v1, Landroid/support/v4/view/y;->d:F
    ...
    iget-object v8, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
    ...
    :cond_14
    iput v3, v0, Landroid/support/v4/view/y;->e:F
    ...
    :cond_17
    iget v8, v0, Landroid/support/v4/view/y;->d:F
    ...
    iget v2, v6, Landroid/support/v4/view/y;->e:F
    ...
    iget v0, v6, Landroid/support/v4/view/y;->e:F
    ...
    iget v3, v6, Landroid/support/v4/view/y;->d:F
    ...
    :goto_17
    iget v9, v0, Landroid/support/v4/view/y;->b:I
    ...
    :cond_1b
    iget v9, v0, Landroid/support/v4/view/y;->d:F

    add-float/2addr v9, v5

    sub-float/2addr v2, v9

    iput v2, v0, Landroid/support/v4/view/y;->e:F

    iget v0, v0, Landroid/support/v4/view/y;->b:I
    ...
    iget v1, v6, Landroid/support/v4/view/y;->d:F
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
    ...
    iget v4, v0, Landroid/support/v4/view/y;->d:F
    ...
    iget-object v0, v6, Landroid/support/v4/view/y;->a:Ljava/lang/Object;
    ...
    iput v1, v0, Landroid/support/v4/view/z;->f:I

    iget-boolean v5, v0, Landroid/support/v4/view/z;->a:Z

    if-nez v5, :cond_24

    iget v5, v0, Landroid/support/v4/view/z;->c:F
    ...
    iget v6, v5, Landroid/support/v4/view/y;->d:F

    iput v6, v0, Landroid/support/v4/view/z;->c:F

    iget v5, v5, Landroid/support/v4/view/y;->b:I

    iput v5, v0, Landroid/support/v4/view/z;->e:I
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->af:Landroid/support/v4/view/af;
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/y;
    ...
    iget v2, v2, Landroid/support/v4/view/y;->b:I
...
.method private c(I)Landroid/support/v4/view/y;
    .locals 3
    ...
    iget v2, v0, Landroid/support/v4/view/y;->b:I
...
.method private d()Landroid/support/v4/view/y;
    .locals 4
    ...
    iget-object v3, v0, Landroid/support/v4/view/y;->a:Ljava/lang/Object;
...
.method private d(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->e()Landroid/support/v4/view/y;
    ...
    iget v4, v1, Landroid/support/v4/view/y;->b:I
    ...
    iget v5, v1, Landroid/support/v4/view/y;->e:F
...
.method private e()Landroid/support/v4/view/y;
    .locals 13
    ...
    iget v10, v0, Landroid/support/v4/view/y;->b:I

    add-int/lit8 v11, v8, 0x1

    if-eq v10, v11, :cond_6

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->e:Landroid/support/v4/view/y;

    add-float/2addr v6, v7

    add-float/2addr v6, v1

    iput v6, v0, Landroid/support/v4/view/y;->e:F

    add-int/lit8 v6, v8, 0x1

    iput v6, v0, Landroid/support/v4/view/y;->b:I

    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;

    iget v6, v0, Landroid/support/v4/view/y;->b:I

    const/high16 v6, 0x3f800000    # 1.0f

    iput v6, v0, Landroid/support/v4/view/y;->d:F
    ...
    :goto_3
    iget v6, v2, Landroid/support/v4/view/y;->e:F

    iget v7, v2, Landroid/support/v4/view/y;->d:F
    ...
    :cond_5
    iget v5, v2, Landroid/support/v4/view/y;->b:I

    iget v4, v2, Landroid/support/v4/view/y;->d:F
...
.method private e(I)Z
    ...
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
...
.method private setScrollState(I)V
    ...
    iget v2, p0, Landroid/support/v4/view/ViewPager;->ah:I
    ...
    :cond_2
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/ac;
    ...
    invoke-static {v5, v2}, Landroid/support/v4/view/n;->b(Landroid/view/View;I)V
...
.method final a()V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
    ...
    iget-boolean v6, v0, Landroid/support/v4/view/z;->a:Z
...
.method public final addFocusables(Ljava/util/ArrayList;II)V
    ...
    iget v4, v4, Landroid/support/v4/view/y;->b:I
...
.method public final addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-boolean v2, v0, Landroid/support/v4/view/z;->a:Z

    instance-of v3, p1, Landroid/support/v4/view/x;

    or-int/2addr v2, v3

    iput-boolean v2, v0, Landroid/support/v4/view/z;->a:Z
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/z;->d:Z
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/d/a;

    invoke-virtual {v3, v0, v2}, Landroid/support/v4/d/a;->a(II)V

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/d/a;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/d/a;
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/d/a;
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/view/z;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected final getChildDrawingOrder(II)I
    ...
    iget v0, v0, Landroid/support/v4/view/z;->f:I
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
    ...
    iget v4, v1, Landroid/support/v4/view/y;->e:F
    ...
    iget v3, v1, Landroid/support/v4/view/y;->b:I
    ...
    iget v10, v2, Landroid/support/v4/view/y;->b:I
    ...
    iget v4, v1, Landroid/support/v4/view/y;->d:F
    ...
    iget v11, v1, Landroid/support/v4/view/y;->d:F
    ...
    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-boolean v7, v1, Landroid/support/v4/view/z;->a:Z

    if-eqz v7, :cond_4

    iget v7, v1, Landroid/support/v4/view/z;->b:I

    and-int/lit8 v7, v7, 0x7

    iget v1, v1, Landroid/support/v4/view/z;->b:I
    ...
    iget-boolean v12, v1, Landroid/support/v4/view/z;->a:Z

    if-nez v12, :cond_2

    invoke-direct/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->d()Landroid/support/v4/view/y;
    ...
    iget v12, v12, Landroid/support/v4/view/y;->e:F
    ...
    iget-boolean v13, v1, Landroid/support/v4/view/z;->d:Z

    if-eqz v13, :cond_1

    const/4 v13, 0x0

    iput-boolean v13, v1, Landroid/support/v4/view/z;->d:Z
    ...
    iget v1, v1, Landroid/support/v4/view/z;->c:F
...
.method protected final onMeasure(II)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/view/z;->a:Z

    if-eqz v1, :cond_3

    iget v1, v0, Landroid/support/v4/view/z;->b:I
    ...
    :cond_2
    :goto_3
    iget v4, v0, Landroid/support/v4/view/z;->width:I
    ...
    iget v2, v0, Landroid/support/v4/view/z;->width:I
    ...
    :goto_4
    iget v11, v0, Landroid/support/v4/view/z;->height:I
    ...
    iget v0, v0, Landroid/support/v4/view/z;->height:I
    ...
    iget v0, v0, Landroid/support/v4/view/z;->c:F
...
.method protected final onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    iget v6, v6, Landroid/support/v4/view/y;->b:I
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, v2}, Landroid/support/v4/view/j;->a(Landroid/view/VelocityTracker;I)F
    ...
    iget v5, v6, Landroid/support/v4/view/y;->e:F

    sub-float/2addr v2, v5

    iget v5, v6, Landroid/support/v4/view/y;->d:F

    div-float/2addr v2, v5

    iget v5, p0, Landroid/support/v4/view/ViewPager;->H:I

    invoke-static {p1, v5}, Landroid/support/v4/view/e;->a(Landroid/view/MotionEvent;I)I

    move-result v5

    invoke-static {p1, v5}, Landroid/support/v4/view/e;->c(Landroid/view/MotionEvent;I)F
    ...
    iget v1, v1, Landroid/support/v4/view/y;->b:I
...
.method public final setAdapter(Landroid/support/v4/view/i;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/support/v4/view/ad;
    ...
    iget v3, v0, Landroid/support/v4/view/y;->b:I
    ...
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/support/v4/view/ad;

    :cond_4
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/i;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/support/v4/view/ad;
    ...
    invoke-direct {p0, v1, v2, v4}, Landroid/support/v4/view/ViewPager;->a(IZZ)V
    ...
    :cond_5
    :goto_2
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/aa;

    if-eqz v1, :cond_6

    if-eq v0, p1, :cond_6

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/aa;
...
.method final setOnAdapterChangeListener(Landroid/support/v4/view/aa;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/aa;

    return-void
.end method

.method public final setOnPageChangeListener(Landroid/support/v4/view/ab;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/ab;
